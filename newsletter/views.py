...
def example(request):
    return render_to_response('example.html', RequestContext(request))
...
def saveImage(request):
    if request.method == "POST":
        ...
        form = FormImagen()
        return render_to_response('form_save.html', {'content': {'form': form}}, RequestContext(request))
...
def getTemplate(request, nameTemplate):
    if nameTemplate:
        ...
        return render_to_response('templates.html', {'body': body_object}, RequestContext(request))
